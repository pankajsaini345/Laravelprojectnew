            ...
            <div class="card-body p-4">
                <form class="row g-3 needs-validation"  enctype='multipart/form-data' method="post">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="header" class="form-control" id="bsValidation1" placeholder=" Name" required>
                      
                    </div>

                   <div class="col-md-12">
                        <label for="bsValidation1" class="form-label">Logo</label>
                        <input type="file" name="image" class="form-control" id="bsValidation1" placeholder=" Name" required>
                      
                    </div>
                    
                    <div class="col-md-12">
                        <label for="bsValidation1" class="form-label">slide</label>
                        <input type="file" name="slide" class="form-control" id="bsValidation1" placeholder=" Name" required >
