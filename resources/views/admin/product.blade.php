            ...
            <div class="card-body p-4">
                <form id="jQueryValidationForm" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="input35"  name="price" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="input35" placeholder="Enter Your Name" name="Quality" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="input37" class="col-sm-3 col-form-label">images</label>
                        <div class="col-sm-9">
                            <input type="file" class="form-control" id="input37" name="images" placeholder="Email Address"  required>
                        </div>
                    </div>
                    <div class="row">
