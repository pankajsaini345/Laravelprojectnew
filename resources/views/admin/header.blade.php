		...
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				<li>
					...
					<ul>
						<li> <a href="{{ url('admin/index') }}"><i class='bx bx-radio-circle'></i>Default</a>
						</li>
						<li> <a href="index2.html"><i class='bx bx-radio-circle'></i>Alternate</a>
						</li>
						<li> <a href="{{ url('admin/Graphical') }}"><i class='bx bx-radio-circle'></i>Graphical</a>
						</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						<li> <a href="{{ url('admin/emailbox') }}"><i class='bx bx-radio-circle'></i>Email</a>
						</li>
						<li> <a href="{{ url('admin/ChatBox') }}"><i class='bx bx-radio-circle'></i>Chat Box</a>
						</li>
						{{-- <li> <a href="app-file-manager.html"><i class='bx bx-radio-circle'></i>File Manager</a>
						</li> --}}
						<li> <a href="{{ url('admin/contactlist') }}"><i class='bx bx-radio-circle'></i>Contatcs</a>
						</li>
						<li> <a href="{{ url('admin/todolist') }}"><i class='bx bx-radio-circle'></i>Todo List</a>
						</li>
						{{-- <li> <a href="app-invoice.html"><i class='bx bx-radio-circle'></i>Invoice</a>
						</li> --}}
						<li> <a href="{{ url('admin/Calendar') }}"><i class='bx bx-radio-circle'></i>Calendar</a>
						</li>
					...
					<li>
						...
						<ul>
							<li> <a href="{{ url('admin/logoview') }}"><i class='bx bx-radio-circle'></i>Logo</a>
							</li>
							<li> <a href="{{ url('admin/sliderview') }}"><i class='bx bx-radio-circle'></i>slider</a>
							</li>
							<li> <a href="{{ url('admin/productview') }}"><i class='bx bx-radio-circle'></i>product</a>
								
							</li>
							<li> <a href="{{ url('admin/Servicesview') }}"><i class='bx bx-radio-circle'></i>Services</a>
						...
						<li>
							<a href="{{url('admin/singup')}}">
								<div class="parent-icon"><i class="bx bx-category"></i>
								</div>
								<div class="menu-title">Sing up</div>
							</a>
						</li>
						 
		
						<li>
							<a href="{{url('admin/formview')}}">
			...
			<li>
				...
				<ul>
					<li> <a href="{{url('admin/yourorde')}}"><i class='bx bx-radio-circle'></i>your order</a>
					</li>
					{{-- <li> <a href="{{url('admin/productview')}}"><i class='bx bx-radio-circle'></i>Product</a>
					</li> --}}
					<li> <a href="#"><i class='bx bx-radio-circle'></i>daily entry</a>
					</li>
